...
Vec3i CUBE_TRIG[12]={Vec3i(0,3,1),
    Vec3i(1, 3, 2),
    Vec3i(5, 4, 0),
    Vec3i(5, 0, 1),
    Vec3i(6, 5, 1),
...
void Mesh::save(std::ostream & out, std::vector<Vector3f> * vert)
{
  std::string vTok("v");
  std::string fTok("f");
